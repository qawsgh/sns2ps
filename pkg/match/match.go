// A match represents the details of a match in Shoot 'n Score It that are
...
// Unmarshal the supplied json, create a list of Match items from this, and
// return the first item in the matches list.
func GetMatch(byteValue []byte) Match {
	allMatches := MatchEntries{}
	json.Unmarshal(byteValue, &allMatches)
...
// Get the match from json and create a list of Match items with the appropriate
// values.
